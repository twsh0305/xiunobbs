## 仓库介绍
我并非作者，这只是原仓库里的源码文件，复刻自官方原版4.0.4仓库，在作者删库前保存的备份，不信可以与程序作者推荐（老黄推荐的docker镜像竟然还在）的docker版中的文件比对，代码部分无差异。本仓库仅对readme.md顶部加了几段话，增加了官方开发文档及AI生成的开发文档。

常见使用问题：[https://www.xiunobbs.cn/thread-132.htm](https://www.xiunobbs.cn/thread-132.htm)

微修复改动版见以下链接，基于原版4.0.4，删除失效官方插件商店，解决插件列表打开缓慢的问题，删除后台首页失效的友联
